...
HD_PWD='G:/Laptop/Facultate/An 2 Semestrul 2/Facultate Eu/AC/MIPS16/MIPS16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestInstructionDecode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestInstructionDecode.tcl
