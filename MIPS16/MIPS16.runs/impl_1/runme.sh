...
HD_PWD='G:/Laptop/Facultate/An 2 Semestrul 2/Facultate Eu/AC/MIPS16/MIPS16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TestInstructionDecode.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TestInstructionDecode.tcl -notrace
